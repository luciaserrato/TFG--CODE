...
def interpolar_z(vol_sparse, micras_entre_cortes, micras_entre_indices):
    ...
    # Suavizado gaussiano Z fuerte para difuminar señal entre cortes reales.
    # sigma = 15 planos = 15 µm → suaviza los 40 µm de hueco entre cortes
    # sin destruir la estructura XY del tumor.
    print("    Suavizando en Z (sigma=15 planos)...")
    vol_denso = ndimage.gaussian_filter1d(vol_denso, sigma=15, axis=0)
