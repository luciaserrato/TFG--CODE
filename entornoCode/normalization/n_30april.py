...
def interpolar_z(vol_sparse, micras_entre_cortes, micras_entre_indices):
    ...
    # Clamp: la cúbica puede generar valores negativos en extrapolación
    vol_denso = vol_denso.clip(0)

    # Suavizado Z leve para eliminar posibles oscilaciones de Runge
    vol_denso = ndimage.gaussian_filter1d(vol_denso, sigma=0.5, axis=0)
